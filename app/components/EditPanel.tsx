...
export function EditPanel({
  ...
  return (
    <div className="pointer-events-auto absolute right-4 top-4 z-10 flex w-[25.35rem] flex-col rounded-2xl border border-slate-200 bg-white p-4 text-sm text-slate-900 shadow-xl">
